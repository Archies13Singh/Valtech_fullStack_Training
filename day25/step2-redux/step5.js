...
let store = creatStore(rootStore,applyMiddleware(logger()))
...
let action = bindactioncreators({actadd,actaddmovie,actremovemovie, actremove, setact, setactmovie},store.dispatch)
